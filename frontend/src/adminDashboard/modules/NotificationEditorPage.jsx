...
export default function NotificationEditorPage({ initialData, onBack, onSaveSuccess }) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-2xs space-y-6 max-w-4xl">
      {/* Header */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-6 border-b border-gray-200">
        <div>
          ...
          >
            <ArrowLeft className="w-4 h-4" /> Back to Broadcast Notifications
          </button>
